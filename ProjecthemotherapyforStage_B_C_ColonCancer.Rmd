...
The description of the variables for this dataset are listed below.  They are also listed as factors.
...
<div class = "blue">
Below are the preliminary findings based on the graphs above and the summary below.  
...
```
<div class = "blue">
Using the stepAIC() function, it appears that the differentiation, extent of spread, location of primary tumor have the greatest impact when assessing AIC.
</div>
