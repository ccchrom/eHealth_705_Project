...
* Demographic Distribution: With regards to the demographic distribution, there is an approximately equal distribution of males and females in the study. The study population is primarily in the 60+ age group followed by the 40-59 year subset. A very small proportion belongs to <40 years age group.

* Treatment Groups: We considered two separate treatment groups for the analysis and both groups had an approximately equal representation.

*Tumor Descriptor: The following colon cancer variables were reviewed as part of the visualization
